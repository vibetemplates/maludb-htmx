...
<div class="card stretch stretch-full" id="my-tasks-card">
    <!-- Card Header -->
            ...
            <div class="card-header-btn">
                <div data-bs-toggle="tooltip" title="Refresh">
                    <a href="javascript:void(0);"
                       ...
                       hx-get="/partials/tasks/my-tasks-table.php?<?= $queryString ?>"
        ...
        <?php if (empty($tasks)): ?>
            ...
            <div class="text-center py-5" id="my-tasks-empty-state">
                ...
                <button class="btn btn-primary mt-3"
                        ...
                        hx-target="#modal-container"
                        hx-swap="innerHTML">
                    <i class="feather-plus me-2"></i>Create Your First Task
                </button>
            </div>
        <?php else: ?>
                                            ...
                                            <div class="d-flex gap-3">
                                                ...
                                                <?php if (!empty($task['assigned_to'])): ?>
                                                    <span class="hstack gap-1 fs-11 fw-normal text-muted">
                                                        ...
                                                        <span><?= htmlspecialchars($task['first_name'] ?? 'Assigned') ?></span>
                                                    </span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary fs-11">Not Assigned</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>

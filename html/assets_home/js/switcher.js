...
(function($) {
	...
	$(".style9" ).click(function(){
		$("#colors" ).attr("href", "css/switcher/style9.css" );
		return false;
	});
	
	$(".style10" ).click(function(){
		$("#colors" ).attr("href", "css/switcher/style10.css" );
		return false;
	});
	
	$(".style11" ).click(function(){
		$("#colors" ).attr("href", "css/switcher/style11.css" );
		return false;
	});
	$(".style12" ).click(function(){
		$("#colors" ).attr("href", "css/switcher/style12.css" );
		return false;
	});
